"""
User Service - Authentication, user profiles, and settings management
"""
import uvicorn
...
# Create FastAPI app
app = FastAPI(
    title="Cleo User Service",
    description="Authentication, user profiles, and settings management",
    version="0.1.0",
    lifespan=lifespan
)
